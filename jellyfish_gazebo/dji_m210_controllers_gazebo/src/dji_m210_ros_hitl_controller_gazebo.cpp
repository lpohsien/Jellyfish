...
public:
  ...
  void Load(physics::ModelPtr _model, sdf::ElementPtr _sdf) {
    ...
    this->gimbal_yaw_joint = _model->GetJoint("gimbal_yaw_joint");
    this->gimbal_roll_joint = _model->GetJoint("gimbal_roll_joint");
    this->gimbal_pitch_joint = _model->GetJoint("gimbal_pitch_joint");
    ...
    ros::SubscribeOptions gimbal_ops =
        ros::SubscribeOptions::create<geometry_msgs::Vector3Stamped>(
            "/dji_sdk/simulated_gimbal_angle", 1000,
...
*/
  ...
  void reset() {
    ...
    this->gimbal_orientation.Set(0, 0, 0);
  }


  void gimbalOrientationCallback(const geometry_msgs::Vector3Stamped::ConstPtr &gimbal_orientation_msg) {
    this->gimbal_pitch_joint->SetPosition(0, gimbal_orientation_msg->vector.x);
    this->gimbal_roll_joint->SetPosition(0, gimbal_orientation_msg->vector.y);
    this->gimbal_yaw_joint->SetPosition(0, gimbal_orientation_msg->vector.z);
  }
...
private:
  ...
  physics::JointPtr gimbal_yaw_joint, gimbal_roll_joint, gimbal_pitch_joint;
